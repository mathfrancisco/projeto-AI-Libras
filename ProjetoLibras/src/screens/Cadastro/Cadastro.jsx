...
export const Cadastro = () => {
  ...
  const handleCadastrar = (e) => {
    ...
    console.log("Formulário de cadastro enviado com sucesso!", formData);
    navigate("/tradutor");
  };
      ...
      <div className="bg-[#f0f0f0] w-[1440px] h-[1024px] relative">
          ...
          <div className="absolute w-[363px] h-[752px] top-0 left-0 rounded-xl">
            <div className="relative h-[464px] rounded-xl">
              ...
              <form onSubmit={handleCadastrar}>
                <div className="w-[363px] h-[73px] top-[92px] left-0 bg-[#324eff] shadow-[0px_2px_4px_#00000029] absolute rounded-xl">
                  <div className="absolute w-[317px] h-[73px] top-0 left-16">
                    ...
                    <input
                      ...
                      className="absolute w-[299px] h-8 top-5 left-[18px] [font-family:'Poppins',Helvetica] font-light text-[#324eff] text-[22px] tracking-[0] leading-[35.2px] whitespace-nowrap bg-transparent border-none outline-none"
                      placeholder="Email"
                    />
                  </div>
                  <img
                ...
                <div className="w-[363px] h-[73px] top-[486px] left-0 bg-[#324eff] shadow-[0px_2px_4px_#00000029] absolute rounded-xl">
                  <div className="absolute w-[317px] h-[73px] top-0 left-16">
                    <div className="absolute w-[299px] h-[73px] top-0 left-0 bg-white rounded-xl" />
                    <input
                      type="text"
                  ...
                  <img
                    className="absolute w-[35px] h-[30px] top-[21px] left-3.5"
                    alt="Group"
                    src="https://c.animaapp.com/j928kLmN/img/group-20@2x.png"
                  />
                </div>
                <div className="absolute w-[367px] h-[175px] top-[581px] left-0">
                  ...
                  <button type="submit" className="w-[363px] h-[73px] top-[51px] left-0 bg-[#324eff] shadow-[0px_2px_4px_#00000029] absolute rounded-xl">
                    <div className="absolute w-full h-8 top-5 left-0 [font-family:'Poppins',Helvetica] font-medium text-white text-[22px] tracking-[0] leading-[35.2px] text-center">
                      Cadastre-se
                    </div>
                  </button>
              ...
              <div className="absolute w-[367px] h-[73px] top-[777px] left-0">
                <div className="w-[363px] h-[73px] top-0 left-0 bg-[#324eff] shadow-[0px_2px_4px_#00000029] absolute rounded-xl">
        ...
        <div className="absolute w-[560px] h-[84px] top-3 left-[462px]">
          <div className="relative w-[558px] h-[84px] bg-[#f9f9f9] rounded-xl">
            ...
            <div className="w-[102px] h-11 top-5 left-[436px] bg-[#181414] absolute rounded-xl">
